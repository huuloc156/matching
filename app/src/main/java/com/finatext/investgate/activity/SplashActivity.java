...
import com.finatext.investgate.activity.login.FirstStartActivity;
...
public class SplashActivity extends BaseActivity implements Animation.AnimationListener {
    ...
    public static final String CLICK_ACTION_DEFAULT = "com.finatext.investgate.activity.SplashActivity";
    public static final String TAG_GCM_PUSH_HANDLE = "gcm-push-handle";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            Timber.tag("gcm-push-handle").i("type" + extras.getString("type"));
            checkStartActivity();
            return;
        }
