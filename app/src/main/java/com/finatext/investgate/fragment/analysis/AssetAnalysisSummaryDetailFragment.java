 ...
 */
public class AssetAnalysisSummaryDetailFragment extends BaseFragment implements OnChartValueSelectedListener {
    @Override
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mChart.setOnChartValueSelectedListener(AssetAnalysisSummaryDetailFragment.this);
...
//giá trị để ở đây
        ...
        for (int i = 0; i < count; i++)
            xVals.add("Phuc ");
//tên biến bỏ đây
        PieDataSet dataSet = new PieDataSet(yVals1, "Chart Name");
