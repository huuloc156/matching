...
public class RecyclerViewHeaderFooterAdapter extends RecyclerView.Adapter {
    ...
    private RecyclerArrayAdapter mIntermediary;
    public RecyclerArrayAdapter getSubAdapter(){
        return mIntermediary;
    }

    public RecyclerViewHeaderFooterAdapter(RecyclerView.LayoutManager manager, RecyclerArrayAdapter intermediary){
        setManager(manager);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        ...
        if(type !=  TYPE_HEADER && type != TYPE_FOOTER) {
            ...
            if(mManagerType == TYPE_MANAGER_STAGGERED_GRID) {
                StaggeredGridLayoutManager.LayoutParams layoutParams1 = new StaggeredGridLayoutManager.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
